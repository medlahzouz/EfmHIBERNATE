...
import com.Dao.ismo.DaoAppartement;
import com.Dao.ismo.DaoEtage;
import com.Dao.ismo.DaoFactory;
import com.Dao.ismo.DaoImmeuble;
import com.Dao.ismo.DaoRue;
			...
			while(i != 0) {
				   ...
				   switch (i) {
					...
					case 3:
						...
						Appartement app=new Appartement(ids,0, null);
					...
					case 4:
						...
						Etage et=new Etage(0, nbApp, null, null);
